...
var Options = settings.Options{
	...
	RegularBattles: settings.OverviewOptions{
		...
		Blocks:           []settings.BlockOptions{BlockBattles, BlockAverageDamage.WithIcon().WithInvisibleIcon(), BlockWinrate.WithIcon().WithInvisibleIcon(), BlockShotAccuracy.WithIcon().WithInvisibleIcon(), BlockWN8Rating.WithIcon().WithInvisibleIcon()},
	},
	...
	VehiclesSlim: settings.VehicleOptions{
		...
		WithLabels:       true,
		Blocks:           []settings.BlockOptions{BlockAverageDamage, BlockWinrateWithBattles.WithIcon().WithInvisibleIcon(), BlockShotAccuracy.WithIcon().WithInvisibleIcon(), BlockWN8Rating.WithIcon().WithInvisibleIcon()},
	},
}
